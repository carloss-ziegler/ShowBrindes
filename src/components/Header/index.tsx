  ...
  return (
    <div className="h-16 bg-[#f89809] flex items-center justify-between shadow px-6 py-1">
      ...
      <div className="flex items-center gap-3">
        <button className="text-sm font-poppins font-medium">Produtos</button>
        <button className="text-sm font-poppins font-medium">Sobre Nós</button>
        <button className="text-sm font-poppins font-medium">Benefícios</button>
        <ButtonTalkToUs />
      </div>
    </div>
  );
